...
## 何、これ？
AmazonLinux2023を以下の構成でセットアップしてWSLにインポートするためのイメージを構築するのものです。WSL界隈、サクッとインストールできるUbuntuやArch使う人が多いかもしれないですが、
仕事上AWSでAmazonLinux2023を相手すること多いのでそんな需要もあるかなーと思って公開してみます。

 - pyenv越しにPython3.14を利用できる
